# Generated by Django 5.2.6 on 2025-09-14 22:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('plant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_plants', to='masters.plant')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_plants', to='masters.product')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_plant', models.ForeignKey(help_text='Finished Good (plant-specific)', on_delete=django.db.models.deletion.CASCADE, related_name='boms', to='masters.productplant')),
            ],
            options={
                'verbose_name': 'BOM',
